...
- `BabylonSpoke.Operations.json`: The `Spoke.Operations.json` scenarios that fit the single collateral and debt reserve limit of the BabylonSpoke, plus the manager-gated liquidations.
