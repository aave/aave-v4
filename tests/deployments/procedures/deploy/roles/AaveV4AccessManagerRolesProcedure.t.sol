...
contract AaveV4AccessManagerRolesProcedureTest is ProceduresBase {
  ...
  function test_labelAllRoles() public {
    ...
    assertTrue(
      accessManager.isRoleLabeled(Roles.BABYLON_SPOKE_CONFIGURATOR_ROLE),
      'BABYLON_SPOKE_CONFIGURATOR labeled'
    );
    assertEq(
      accessManager.getLabelOfRole(Roles.BABYLON_SPOKE_CONFIGURATOR_ROLE),
      'BABYLON_SPOKE_CONFIGURATOR_ROLE'
    );
    assertEq(
      accessManager.getRoleOfLabel('BABYLON_SPOKE_CONFIGURATOR_ROLE'),
      Roles.BABYLON_SPOKE_CONFIGURATOR_ROLE
    );
