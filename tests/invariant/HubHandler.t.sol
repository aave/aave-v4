...
//   function getReserveSupplied(address underlying) public view returns (uint256) {
//     return s.reserveSupplied[underlying];
//   }

//   function getUserSupplied(address underlying, address user) public view returns (uint256) {
//     return s.userSupplied[underlying][user];
//   }
...
//   function getLastExchangeRate(address underlying) public view returns (uint256) {
//     return s.lastExchangeRate[underlying];
//   }

//   function supply(address underlying, address user, uint256 amount, address onBehalfOf) public {
...
//     deal(hub1.getAsset(underlying).underlying, user, amount);
//     Utils.add({
//       hub: hub1,
...
//     _updateState(underlying);
//     s.reserveSupplied[underlying] += amount;
//     s.userSupplied[underlying][onBehalfOf] += amount;
//   }

//   function withdraw(address underlying, address user, uint256 amount, address to) public {
//     underlying = bound(underlying, 0, hub1.getAssetCount() - 1);
...
//     _updateState(underlying);
//     s.reserveSupplied[underlying] -= amount;
//     s.userSupplied[underlying][user] -= amount;
//   }

//   function donate(address underlying, address user, uint256 amount) public {
...
//   function _updateState(address underlying) internal {
//     revert('implement me');

//     // IHub.Asset memory reserveData = hub1.getAsset(underlying);
//     // // todo: remove last exchange rate, bad idea to store like this, looses precision
//     // s.lastExchangeRate[underlying] = reserveData.suppliedShares == 0
//     //   ? 0
//     //   : hub1.getTotalAssets(underlying) / reserveData.suppliedShares;
//   }
