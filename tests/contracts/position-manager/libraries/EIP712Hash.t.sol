...
contract EIP712HashTest is Test {
  ...
  function test_hash_setUsingAsCollateral_fuzz(
    ...
    assertEq(
      w.hashSetUsingAsCollateral(params),
      vm.eip712HashStruct('SetUsingAsCollateral', abi.encode(params))
    );
  }
  ...
  function test_hash_updateUserRiskPremium_fuzz(
    ...
    assertEq(
      w.hashUpdateUserRiskPremium(params),
      vm.eip712HashStruct('UpdateUserRiskPremium', abi.encode(params))
    );
  }
  ...
  function test_hash_updateUserDynamicConfig_fuzz(
    ...
    assertEq(
      w.hashUpdateUserDynamicConfig(params),
      vm.eip712HashStruct('UpdateUserDynamicConfig', abi.encode(params))
    );
  }
}
