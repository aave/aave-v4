...
library Constants {
  ...
  uint256 internal constant MAX_ALLOWED_BORROW_RATE = 1000_00; // 1000.00% in BPS
  uint256 internal constant MIN_ALLOWED_BORROW_RATE = 0; // not defined in AssetInterestRateStrategy
