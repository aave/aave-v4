...
contract SpokeOperations_Gas_Tests is Base {
  function setUp() public override {
    ...
    hub.supply(wethAssetId, 1000e18, bob);
    hub.supply(usdxAssetId, 1000e6, bob);
    hub.supply(wbtcAssetId, 1000e8, bob);
    vm.stopPrank();
  }
  ...
  function test_restore() public {
    ...
    skip(1000);
    uint256 debtRemaining = spoke1.getUserTotalDebt(spokeInfo[spoke1].dai.reserveId, alice);
    spoke1.repay(spokeInfo[spoke1].dai.reserveId, debtRemaining);
