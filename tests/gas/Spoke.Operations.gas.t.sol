...
contract SpokeOperations_Gas_Tests is Base {
  ...
  function test_restore() public {
    ...
    spoke1.repay(spokeInfo[spoke1].dai.reserveId, MAIN_HUB, 200e18);
    vm.snapshotGasLastCall('Spoke.Operations', 'repay: partial');

    skip(1000);
    spoke1.repay(spokeInfo[spoke1].dai.reserveId, MAIN_HUB, type(uint256).max);
  ...
  function test_updateRiskPremium() public {
    ...
    spoke1.borrow(spokeInfo[spoke1].usdx.reserveId, MAIN_HUB, 500e6, alice);
