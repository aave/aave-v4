...
contract SpokeConfiguratorTest is SpokeBase {
  ...
  function test_addCollateralFactor() public {
    ...
    uint40 expectedConfigKey = _nextDynamicConfigKey(spoke, reserveId);
    ...
    vm.prank(SPOKE_CONFIGURATOR);
    uint40 dynamicConfigKey = spokeConfigurator.addCollateralFactor(
      spokeAddr,
      reserveId,
      newCollateralFactor
    );
  ...
  function test_addMaxLiquidationBonus() public {
    ...
    emit ISpoke.AddDynamicReserveConfig(reserveId, expectedConfigKey, expectedDynamicReserveConfig);
    vm.prank(SPOKE_CONFIGURATOR);
    uint40 dynamicConfigKey = spokeConfigurator.addMaxLiquidationBonus(
      spokeAddr,
      reserveId,
      newLiquidationBonus
    );
  ...
  function test_addLiquidationFee() public {
    ...
    emit ISpoke.AddDynamicReserveConfig(reserveId, expectedConfigKey, expectedDynamicReserveConfig);
    vm.prank(SPOKE_CONFIGURATOR);
    uint40 dynamicConfigKey = spokeConfigurator.addLiquidationFee(
      spokeAddr,
      reserveId,
      newLiquidationFee
    );
  ...
  function test_addDynamicReserveConfig() public {
    ...
    vm.prank(SPOKE_CONFIGURATOR);
    uint40 actualConfigKey = spokeConfigurator.addDynamicReserveConfig(
      spokeAddr,
      reserveId,
