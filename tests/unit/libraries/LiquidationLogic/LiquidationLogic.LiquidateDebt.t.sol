...
//     realizedPremiumRay = _calculatePremiumDebtRay(
//       hub,
//       assetId,
//       1e3 * 1e18,
//       int256(1e3 * 1e18 * WadRayMath.RAY)
//     );
...
//       IHubBase.PremiumDelta(
//         -1e3 * 1e18,
//         -realizedPremiumRay.toInt256() - 1e3 * 1e18 * WadRayMath.RAY.toInt256(),
//         0
//       )
//     );
...
//       offsetDeltaRay: -premiumDebtRay.toInt256() - premiumOffsetRay.toInt256(),
...
//     uint256 accruedPremiumRay = premiumDebtRay - realizedPremiumRay;
...
//       (premiumDebtRay - accruedPremiumRay) -  _calculatePremiumAssetsRay(hub, assetId, premiumDebtShares) - accruedPremiumRay
//     );
...
//     initialPosition.premiumOffsetRay = -premiumDebtRay.toInt256().toInt200();
