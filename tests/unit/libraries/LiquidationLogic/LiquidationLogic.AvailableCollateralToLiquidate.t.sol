...
contract LiquidationAvailableCollateralToLiquidateTest is Base {
  ...
  function testCalculateAvailableCollateralToLiquidate_collateralAssetPrice_zero(
    ...
    // // Set collateral asset price to zero
    ...
    // ) = LiquidationLogic.calculateAvailableCollateralToLiquidate(_setFunctionArgs(params));

    // assertEq(collateralAmount, 0);
    // assertEq(debtAmountNeeded, 0);
    // assertEq(liquidationProtocolFeeAmount, 0);
  }
