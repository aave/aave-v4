...
contract LiquidationLogicLiquidateUserTest is LiquidationLogicBaseTest {
  ...
  function updateStorage(ISpoke.LiquidationConfig memory newLiquidationConfig) internal {
    liquidationLogicWrapper.setLiquidationConfig(newLiquidationConfig);
  }

  function updateStorage(ISpoke.DynamicReserveConfig memory newDynamicCollateralConfig) internal {
    liquidationLogicWrapper.setDynamicCollateralConfig(newDynamicCollateralConfig);
  }
}
