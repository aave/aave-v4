...
//   uint256 mockUnderlying = uint256(keccak256('mockUnderlying'));
...
//     rateStrategy.setInterestRateData(mockUnderlying, encodedRateData);
//   }
...
//     assertEq(rateStrategy.getInterestRateData(mockUnderlying), rateData);
//   }

//   function test_getOptimalUsageRatio() public view {
//     assertEq(rateStrategy.getOptimalUsageRatio(mockUnderlying), rateData.optimalUsageRatio);
//   }

//   function test_getBaseVariableBorrowRate() public view {
//     assertEq(
//       rateStrategy.getBaseVariableBorrowRate(mockUnderlying),
//       rateData.baseVariableBorrowRate
//     );
//   }

//   function test_getVariableRateSlope1() public view {
//     assertEq(rateStrategy.getVariableRateSlope1(mockUnderlying), rateData.variableRateSlope1);
//   }

//   function test_getVariableRateSlope2() public view {
//     assertEq(rateStrategy.getVariableRateSlope2(mockUnderlying), rateData.variableRateSlope2);
//   }

//   function test_getMaxVariableBorrowRate() public view {
//     assertEq(
//       rateStrategy.getMaxVariableBorrowRate(mockUnderlying),
...
//     uint256 mockUnderlying2 = uint256(keccak256('mockUnderlying2'));
//     vm.expectRevert(
