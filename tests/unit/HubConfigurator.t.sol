...
contract HubConfiguratorTest is HubBase {
  ...
  function test_addSpokeToAssets_revertsWith_MismatchedConfigs() public {
    ...
    spokeConfigs[0] = IHub.SpokeConfig({addCap: 1, drawCap: 2, refreshPremium: true, active: true});
    spokeConfigs[1] = IHub.SpokeConfig({addCap: 3, drawCap: 4, refreshPremium: true, active: true});
    spokeConfigs[2] = IHub.SpokeConfig({addCap: 5, drawCap: 6, refreshPremium: true, active: true});
