...
contract SpokeUserAccountDataTest is SpokeBase {
  ...
  function test_userAccountData_scenario1() public {
    ...
    _checkedUserAccountData(
      ...
      ISpoke.UserAccountData({
        ...
        inflatedTotalDebtValue: 75e26 +
          _convertAmountToValue(spoke, _wethReserveId(spoke), PREMIUM_DEBT_BUFFER),
  ...
  function test_userAccountData_scenario4() public {
    ...
    _checkedUserAccountData(
      ...
      ISpoke.UserAccountData({
        ...
        inflatedTotalDebtValue: 1000e26 +
          _convertAmountToValue(spoke, _wethReserveId(spoke), PREMIUM_DEBT_BUFFER),
  ...
  function test_userAccountData_scenario5() public {
    ...
    _checkedUserAccountData(
      ...
      ISpoke.UserAccountData({
        ...
        inflatedTotalDebtValue: 125e26 +
          _convertAmountToValue(spoke, _wethReserveId(spoke), PREMIUM_DEBT_BUFFER) +
          _convertAmountToValue(spoke, _wbtcReserveId(spoke), PREMIUM_DEBT_BUFFER),
        avgCollateralFactor: 0.72e18,
  ...
  function assertApproxEq(
    ...
    assertEq(a.inflatedTotalDebtValue, b.inflatedTotalDebtValue, 'inflatedTotalDebtValue');
