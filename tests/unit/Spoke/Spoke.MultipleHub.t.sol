...
contract SpokeMultipleHubTest is SpokeBase {
  ...
  function test_borrow_secondHub() public {
    ...
    assertEq(getAssetAddedAmount(hub1, daiAssetId), hub1SupplyAmount);
  ...
  function test_borrow_thirdHub() public {
    ...
    assertEq(getAssetAddedAmount(hub1, daiAssetId), daiSupplyAmount);
    ...
    assertEq(getAssetAddedAmount(hub3, hub3DaiAssetId), MAX_SUPPLY_AMOUNT);
    ...
    assertEq(getAssetAddedAmount(hub1, daiAssetId), MAX_SUPPLY_AMOUNT - daiSupplyAmount);
  }
}
