...
//     hub3.addSpoke(hub3address(tokenList.dai), address(spoke1), spokeConfig);
...
//     assertEq(hub3.getAddedAssets(hub3address(tokenList.dai)), MAX_SUPPLY_AMOUNT);
