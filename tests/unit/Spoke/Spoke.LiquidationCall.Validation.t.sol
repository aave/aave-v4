...
contract LiquidationCallValidationTest is SpokeBase {
  function test_liquidationCall_revertsWith_ReserveNotActive_collateralReserve() public {
    ...
    test_liquidationCall_fuzz_revertsWith_ReserveNotActive_collateral(
      wethAssetId,
      daiReserveId,
      debtToCover
    );
  ...
  function test_liquidationCall_fuzz_revertsWith_ReserveNotActive_collateral(
    uint256 reserveId1,
    uint256 reserveId2,
    uint256 debtToCover
  ) public {
  ...
  function test_liquidationCall_revertsWith_ReserveNotActive_debtReserve() public {
    ...
    test_liquidationCall_fuzz_revertsWith_ReserveNotActive_debt(
      wethAssetId,
      daiReserveId,
      debtToCover
    );
  ...
  function test_liquidationCall_fuzz_revertsWith_ReserveNotActive_debt(
    uint256 reserveId1,
    uint256 reserveId2,
    uint256 debtToCover
  ) public {
