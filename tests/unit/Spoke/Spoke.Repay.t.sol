...
contract SpokeRepayTest is SpokeBase {
  ...
  function test_repay() public {
    ...
    assertEq(
      ...
      hub.convertToAddedShares(wethAssetId, wethSupplyAmount)
    );
  ...
  function test_repay_only_interest() public {
    ...
    assertApproxEqAbs(bobDaiAfter.drawnDebt, daiBorrowAmount, 1, 'bob dai base debt final balance');
    assertApproxEqAbs(
      spoke1.getUserTotalDebt(_daiReserveId(spoke1), bob),
      daiBorrowAmount,
      2,
  ...
  function test_repay_max() public {
    ...
    emit ISpoke.Repay(
      ...
      bob,
      bob,
      hub.convertToDrawnShares(daiAssetId, bobDaiBefore.drawnDebt)
    );
  ...
  function test_fuzz_amounts_repay_only_premium(
    ...
    assertEq(bobDaiDataAfter.suppliedShares, bobDaiDataBefore.suppliedShares);
    assertEq(bobDaiAfter.drawnDebt, bobDaiBefore.drawnDebt, 'bob dai base debt final balance');
    assertApproxEqAbs(
      bobDaiAfter.premiumDebt,
  ...
  function test_repay_fuzz_amounts_base_debt_no_premium(
    ...
    // Bob repays
    uint256 bobDaiBaseDebt = bobDaiBefore.drawnDebt - daiBorrowAmount;
