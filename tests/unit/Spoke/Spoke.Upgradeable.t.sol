...
//     ISpoke spokeImpl = _deployMockSpokeInstance(revision);
...
//     ISpoke spokeImpl = _deployMockSpokeInstance(initialRevision);
...
//     ISpoke spokeImpl2 = _deployMockSpokeInstance(secondRevision);
...
//     ISpoke spokeImpl = _deployMockSpokeInstance(0);
...
//     ISpoke spokeImpl = Deploy.deployISpoke(oracle);
...
//     ISpoke spokeImpl2 = _deployMockSpokeInstance(2);
//     vm.expectRevert(ISpoke.InvalidAddress.selector);
//     vm.prank(_getProxyAdminAddress(address(spokeProxy)));
...
//     return abi.encodeCall(ISpoke.initialize, address(accessManager));
//   }

//   function _deployMockSpokeInstance(uint64 revision) internal returns (ISpoke) {
//     return ISpoke(address(Deploy.deployMockSpokeInstance(revision, oracle)));
//   }
// }
