...
contract SpokeConfigTest is SpokeBase {
  ...
  function test_setUsingAsCollateral_revertsWith_ReserveFrozen() public {
    ...
    assertTrue(isUsingAsCollateral(spoke1, alice, daiReserveId), 'alice using as collateral');
    assertFalse(isUsingAsCollateral(spoke1, bob, daiReserveId), 'bob not using as collateral');
    ...
    assertFalse(
      isUsingAsCollateral(spoke1, alice, daiReserveId),
  ...
  function test_setUsingAsCollateral_collateralStatusUnchanged() public {
    ...
    assertFalse(isUsingAsCollateral(spoke1, bob, daiReserveId));
    ...
    assertTrue(isUsingAsCollateral(spoke1, bob, daiReserveId), 'bob using as collateral');
    ...
    assertTrue(isUsingAsCollateral(spoke1, bob, daiReserveId));
    assertEq(_getUserRpStored(spoke1, daiReserveId, bob), bobRp);
    assertEq(_getUserDynConfigKeys(spoke1, bob), bobDynConfig);
  }
  ...
  function test_setUsingAsCollateral() public {
    ...
    assertEq(
      isUsingAsCollateral(spoke1, bob, daiReserveId),
      usingAsCollateral,
