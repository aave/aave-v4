...
contract SpokeMultipleHubIsolationModeTest is SpokeMultipleHubBase {
  ...
  function test_isolation_mode() public {
    ...
    assertEq(
      getAssetAddedAmount(newHub, isolationVars.assetAId),
      MAX_SUPPLY_AMOUNT,
    ...
    assertEq(
      getAssetAddedAmount(hub1, isolationVars.assetBIdMainHub),
      500_000e18,
    ...
    assertEq(
      getAssetAddedAmount(newHub, isolationVars.assetBId),
      MAX_SUPPLY_AMOUNT,
