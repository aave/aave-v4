...
contract TokenizationSpokeTest is TokenizationSpokeBaseTest {
  ...
  function test_deposit() public {
    ...
    uint256 assets = vm.randomUint(1, _calculateMaxSupplyAmount(vault));
  ...
  function test_mint() public {
    address depositor = alice;
    uint256 shares = vm.randomUint(1, _calculateMaxSupplyAmount(vault));
  ...
  function test_withdraw() public {
    address owner = alice;
    uint256 depositAssets = vm.randomUint(1, _calculateMaxSupplyAmount(vault));
  ...
  function test_redeem() public {
    address owner = alice;
    uint256 mintShares = vm.randomUint(1, _calculateMaxSupplyAmount(vault));
