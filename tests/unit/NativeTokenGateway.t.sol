...
contract NativeTokenGatewayTest is Base {
  ...
  function test_supplyNative_revertsWith_NotNativeWrapper() public {
    uint256 amount = 100e18;
    vm.expectRevert(INativeTokenGateway.NotNativeWrapper.selector);
    vm.prank(bob);
  ...
  function test_withdrawNative_revertsWith_NotNativeWrapper() public {
    uint256 amount = 100e18;
  ...
  function test_borrowNative_revertsWith_NotNativeWrapper() public {
    uint256 borrowAmount = 5e18;
  ...
  function test_repayNative_revertsWith_NotNativeWrapper() public {
    uint256 repayAmount = 5e18;
