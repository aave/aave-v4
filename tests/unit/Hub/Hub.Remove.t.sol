...
//       underlying,
//       address(spoke1),
//       hub1.previewRemoveByAssets(underlying, amount),
//       amount
//     );

//     vm.prank(address(spoke1));
//     hub1.remove(underlying, amount, alice);

//     AssetPosition memory assetData = getAssetPosition(hub1, underlying);
...
//     );
//     assertHubLiquidity(hub1, underlying, 'hub1.remove');
//     // spoke
...
//     Utils.remove(hub1, underlying, address(spoke1), amount, alice);
//     Utils.remove(hub1, underlying, address(spoke2), amount2, alice);
...
//     uint256 spoke1Amount = hub1.getSpokeAddedAssets(underlying, address(spoke1));
//     Utils.remove(hub1, underlying, address(spoke1), spoke1Amount, alice);

//     uint256 spoke2Amount = hub1.getSpokeAddedAssets(underlying, address(spoke2));
//     Utils.remove(hub1, underlying, address(spoke2), spoke2Amount, alice);
...
//     assertEq(
//       assetData.liquidity,
//       hub1.getAsset(underlying).realizedFees + _calculateBurntInterest(hub1, underlying),
