...
contract LiquidityHubRestoreTest is LiquidityHubBase {
  ...
  function test_restore_revertsWith_SurplusAmountRestored_baseDebt() public {
  ...
  function test_restore_revertsWith_SurplusAmountRestored_premiumDebt() public {
    uint256 daiAmount = 100e18;
    uint256 drawAmount = daiAmount;
    // spoke2 supply dai
    Utils.supply({
    ...
    uint256 restoreAmount = premiumDebt + 1; // invalid restore amount
    vm.expectRevert(
  ...
  function test_restore_revertsWith_InvalidRestoreAmount_zero() public {
    ...
    vm.prank(address(spoke1));
    hub.restore({assetId: daiAssetId, baseAmount: 0, premiumAmount: 0, repayer: alice});
  }

  function test_restore_revertsWith_InvalidRestoreAmount_zero_with_debt() public {
    uint256 daiAmount = 100e18;
    uint256 drawAmount = daiAmount;
    // spoke2 supply dai
    Utils.supply({
  ...
  function test_restore_fuzz_revertsWith_InvalidRestoreAmount_zero_with_debt(
    uint256 daiAmount
  ) public {
