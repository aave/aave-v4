...
contract LiquidityHubDonateTest is LiquidityHubBase {
  ...
  function test_donate_revertsWith_SupplyCapExceeded() public {
    ...
    _updateSupplyCap(
      daiAssetId,
      address(hub.getAsset(daiAssetId).config.feeReceiver),
      newSupplyCap
    );
  ...
  // function test_donate_revertsWith_SupplyCapExceeded_due_to_rounding() public {
  ...
  // function test_donate_SupplyCapReachedButNotExceeded() public {
  //   _increaseExchangeRate(daiAssetId, 100e18);
  ...
  // function test_donate_fuzz_single_spoke_multi_supply(
  //   uint256 amount,
  //   uint256 skipTime,
  //   uint256 rate
  // ) public {
