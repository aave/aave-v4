...
contract LiquidityHubAccrueInterestTest is BaseTest {
  ...
  function test_accrueInterest_fuzz_ChangingBorrowRate(
    ...
    // uint256 borrowAmount = 430610211942067744538650113656;
    // uint40 elapsed = 8307728687;
    // uint256 riskPremium = 410701050;

    // uint256 borrowAmount = 1;
    // uint40 elapsed = 144884908;
    // uint256 riskPremium = 27935726;
    ...
    // console.log(
    //   'calc totalBase',
    //   borrowAmount.rayMul(cumulated.t1.rayMul(assetData.t0.baseBorrowIndex)).rayDiv(
    //     assetData.t0.baseBorrowIndex
    //   ),
    //   totalBase
    // );
    ...
    // console.log(
    //   'calc totalBase',
    //   totalBase.rayMul(cumulated.t2.rayMul(assetData.t1.baseBorrowIndex)).rayDiv(
    //     assetData.t1.baseBorrowIndex
    //   ),
    //   totalBase +
    //     totalBase.rayMul(
    //       MathUtils.calculateLinearInterest(baseBorrowRate, timestamps.t1) - WadRayMath.RAY
    //     )
    // );
    ...
    //   'totalBase',
    //   totalBase,
    //   totalBase.rayMul(cumulated.t2.rayMul(assetData.t2.baseBorrowIndex)).rayDiv(
    //     assetData.t1.baseBorrowIndex
    //   )
    // );
  ...
  // function skip_test_accrueInterest_fuzz_ChangingBorrowRate() public // uint256 borrowAmount,
  // // uint40 elapsed,
  // // uint256 riskPremium
  // {
  //   Timestamps memory timestamps;
  ...
  //   // console.log('inputs', borrowAmount, elapsed, riskPremium);
  ...
  //   uint256 baseBorrowRate = hub.getBaseInterestRate(daiAssetId);
  //   // Asset memory daiInfo0 = hub.getAsset(daiAssetId);
  ...
  //   //   baseBorrowRate,
  //   //   uint40(timestamps.t0)
  //   // );
  //   // uint256 baseBorrowIndex = cumulatedBaseInterest.rayMul(assetData.t0.baseDebt);

  //   uint256 totalBase = borrowAmount.rayMul(baseBorrowIndex).rayDiv(assetData.t0.baseDebt);
  ...
  //   // Say borrow rate changes
  //   uint256 baseBorrowRate0 = baseBorrowRate;
  //   baseBorrowRate *= 2;
  //   vm.mockCall(
  //     address(irStrategy),
  //     IReserveInterestRateStrategy.calculateInterestRates.selector,
  ...
  //   // Spoke 1's debt individually has not yet accrued, even though total debt has accrued
  //   assertEq(hub.getSpoke(daiAssetId, address(spoke1)).baseDebt, borrowAmount, 'hub baseDebt');

  //   uint256 nextBaseBorrowIndex = baseBorrowIndex.rayMul(
  //     MathUtils.calculateLinearInterest(baseBorrowRate, uint40(timestamps.t0))
  //   );
  //   // console.log('calcBase', totalBase.rayMul(nextBaseBorrowIndex).rayDiv(baseBorrowIndex));

  //   // totalBase = MathUtils.calculateLinearInterest(baseBorrowRate0, uint40(startTime)).rayMul(
  //   //   totalBase
  //   // );
  //   // console.log('totalBase', totalBase);
  //   totalBase = totalBase.rayMul(nextBaseBorrowIndex).rayDiv(baseBorrowIndex);
  ...
  //   // vm.assume(daiInfo.baseDebt >= 100 && daiInfo.outstandingPremium >= 100);

  //   // console.log('cumulatedBaseInterest', cumulatedBaseInterest);
  //   // console.log('daiInfo.baseDebt %e, totalBase %e', daiInfo.baseDebt, totalBase);

  //   assertApproxEqRel(totalBase, assetData.t1.baseDebt, 0.01e18);
  //   assertApproxEqRel(
  //     (totalBase - borrowAmount).radMul(riskPremium),
  //     assetData.t1.outstandingPremium,
  //     0.01e18 // loss propagates
