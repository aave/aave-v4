...
/// @dev Have to override `_domainNameAndVersion()` to specify the EIP712 domain name and version.
/// @dev Follows EIP-5267, with `address(this)` as verifyingContract and no custom extensions or optional EIP-712 salt.
