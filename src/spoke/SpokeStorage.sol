...
abstract contract SpokeStorage {
  ...
  /// @dev Map of reserve bucket binary data to their Reserve data.
  ...
  /// @dev Map of reserve bucket binary data and dynamic configuration keys to the dynamic configuration data.
  ...
  /// @dev Map of user addresses and reserve bucket binary data to user positions.
