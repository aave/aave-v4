...
interface ISpoke is ISpokeBase, IMulticall, INoncesKeyed, IAccessManaged {
  ...
  /// @notice Returns the minimum change in risk premium to trigger a refresh.
  /// @return The minimum change in risk premium in absolute terms to trigger a refresh, expressed in bps (e.g. 2_00 is 2.00%).
