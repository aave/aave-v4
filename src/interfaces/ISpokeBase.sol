...
interface ISpokeBase {
   ...
   * @param collateralReserveId The reserve identifier of the underlying asset used as collateral, to receive as result of the liquidation.
   * @param debtReserveId The reserve identifier of the underlying borrowed asset, to be repaid with the liquidation.
