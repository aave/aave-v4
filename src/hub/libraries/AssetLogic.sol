...
library AssetLogic {
  ...
  function updateDrawnRate(IHub.Asset storage asset, address assetAddress) internal {
    ...
    emit IHub.UpdateAsset(assetAddress, drawnIndex, newDrawnRate, asset.realizedFees);
  }
