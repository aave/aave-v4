...
interface IHubBase {
  ...
  event Add(address indexed underlying, address indexed spoke, uint256 shares, uint256 amount);
  ...
  event Remove(address indexed underlying, address indexed spoke, uint256 shares, uint256 amount);
