...
interface IHub is IHubBase, IAccessManaged {
  ...
  /// @dev If the fee receiver is updated, adds it as a new spoke with maximum add cap and zero draw cap, and sets old
  /// fee receiver caps and risk premium threshold to zero.
