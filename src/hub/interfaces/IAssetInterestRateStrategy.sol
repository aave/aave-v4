...
interface IAssetInterestRateStrategy is IBasicInterestRateStrategy {
  ...
  /// @param asset The address of the asset that has new interest rate data set.
  ...
  /// @param asset The address of the asset to get the data for.
  ...
  /// @param asset The address of the asset to get the optimal usage ratio for.
  /// @return The optimal usage ratio, in BPS.
  function getOptimalUsageRatio(address asset) external view returns (uint256);

  /// @notice Returns the base variable borrow rate.
  /// @param asset The address of the asset to get the base variable borrow rate for.
  ...
  /// @param asset The address of the asset to get the variable rate slope 1 for.
  ...
  /// @param asset The address of the asset to get the variable rate slope 2 for.
  /// @return The variable rate slope, in BPS.
  function getVariableRateSlope2(address asset) external view returns (uint256);

  /// @notice Returns the maximum variable borrow rate.
  /// @param asset The address of the asset to get the maximum variable borrow rate for.
