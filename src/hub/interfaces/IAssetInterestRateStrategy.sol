...
interface IAssetInterestRateStrategy is IBasicInterestRateStrategy {
  ...
  /// @dev optimalUsageRatio The optimal usage ratio, expressed in BPS. Maximum and minimum values are defined by `MAX_OPTIMAL_RATIO` and `MIN_OPTIMAL_RATIO`.
  /// @dev baseVariableBorrowRate The base variable borrow rate, expressed in BPS.
  /// @dev variableRateSlope1 The slope of the variable interest curve, before hitting the optimal usage ratio, expressed in BPS.
  /// @dev variableRateSlope2 The slope of the variable interest curve, after hitting the optimal usage ratio, expressed in BPS.
  ...
  /// @param optimalUsageRatio The optimal usage ratio, expressed in BPS.
  /// @param baseVariableBorrowRate The base variable borrow rate, expressed in BPS.
  /// @param variableRateSlope1 The slope of the variable interest curve, before hitting the optimal usage ratio, expressed in BPS.
  /// @param variableRateSlope2 The slope of the variable interest curve, after hitting the optimal usage ratio, expressed in BPS.
  ...
  /// @return The optimal usage ratio, expressed in BPS.
  ...
  /// @return The base variable borrow rate, expressed in BPS.
  ...
  /// @return The variable rate slope, expressed in BPS.
  ...
  /// @return The maximum variable borrow rate, expressed in BPS.
  ...
  /// @return The maximum rate, expressed in BPS.
