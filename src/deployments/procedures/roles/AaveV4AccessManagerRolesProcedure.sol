...
library AaveV4AccessManagerRolesProcedure {
  ...
  function labelAllRoles(address accessManager) internal {
    ...
    // Hub roles
    am.labelRole(Roles.HUB_DOMAIN_BASE_ROLE, 'HUB_DOMAIN_BASE_ROLE');
    ...
    am.labelRole(Roles.HUB_CONFIGURATOR_DOMAIN_BASE_ROLE, 'HUB_CONFIGURATOR_DOMAIN_BASE_ROLE');
    am.labelRole(
    ...
    // Spoke roles
    am.labelRole(Roles.SPOKE_DOMAIN_BASE_ROLE, 'SPOKE_DOMAIN_BASE_ROLE');
    ...
    am.labelRole(Roles.SPOKE_CONFIGURATOR_DOMAIN_BASE_ROLE, 'SPOKE_CONFIGURATOR_DOMAIN_BASE_ROLE');
    am.labelRole(
