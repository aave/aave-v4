...
contract Spoke is ISpoke, Multicall, AccessManaged {
  ...
  function withdraw(uint256 reserveId, uint256 amount, address to) external {
    ...
    _accruePremiumDebt(reserve, userPosition, hub, assetId, msg.sender);
  ...
  function _refresh(
    ...
    reserve.realizedPremium += realizedPremium;
  ...
  function _executeLiquidationCall(
    ...
    while (vars.i < usersLength) {
      ...
      userDebtPosition.realizedPremium -= vars.premiumDebtToLiquidate;
