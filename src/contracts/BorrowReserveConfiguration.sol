...
/**
 * @title BorrowReserveConfiguration library
 * @author Aave Labs
 * @notice Implements the bitmap logic to handle the borrow reserve configuration
 */
library BorrowReserveConfiguration {
  ...
  function setLiquidationThreshold(
    DataTypes.BorrowReserveConfig memory self,
    uint256 threshold
  ) internal pure {
   ...
   */
  function setActive(DataTypes.BorrowReserveConfig memory self, bool active) internal pure {
    self.data =
   ...
   */
  function getActive(DataTypes.BorrowReserveConfig memory self) internal pure returns (bool) {
   ...
   */
  function setFrozen(DataTypes.BorrowReserveConfig memory self, bool frozen) internal pure {
    self.data =
   ...
   */
  function getFrozen(DataTypes.BorrowReserveConfig memory self) internal pure returns (bool) {
   ...
   */
  function setPaused(DataTypes.BorrowReserveConfig memory self, bool paused) internal pure {
    self.data =
   ...
   */
  function getPaused(DataTypes.BorrowReserveConfig memory self) internal pure returns (bool) {
   ...
   */
  function setDrawCap(DataTypes.BorrowReserveConfig memory self, uint256 drawCap) internal pure {
   ...
   * @return The draw cap
   */
  function getDrawCap(DataTypes.BorrowReserveConfig memory self) internal pure returns (uint256) {
   ...
   */
  function getSupplyCap(DataTypes.BorrowReserveConfig memory self) internal pure returns (uint256) {
